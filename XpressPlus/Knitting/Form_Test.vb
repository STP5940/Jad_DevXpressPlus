...
Public Class Form_Test
    ...
    Private QtyrollStore As Object
    Private QtyrollOrder As Object
    ...
    Private Sub Formknittingform_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        'WgtKgOrder.Text = "0"
        'WgtKgStore.Text = "0"
        'QtyrollsOrder.Text = "0"
        'QtyrollsStore.Text = "0"
    ...
    Private Sub Btfinddlvno_Click(sender As Object, e As EventArgs) Handles Btfinddlvno.Click
        ...
        'Test
        'Dtprecdate.Text = Trim(Frm.Dgvmas.CurrentRow.Cells("Mdyarndate").Value)
        Bindmasterdlv()
    End Sub
    ...
    Private Sub Bindmasterknit()
        ...
        If Tmasterknit.Rows.Count > 0 Then
            ...
            'Test
            'WgtKgOrder.Text = Tmasterknit.Rows(0)("WgtKgOrder")
            'WgtKgStore.Text = Tmasterknit.Rows(0)("WgtKgStore")
            'QtyrollOrder.Text = Tmasterknit.Rows(0)("QtyrollOrder")
            'QtyrollStore.Text = Tmasterknit.Rows(0)("QtyrollStore")
            'Test----
    ...
    Private Sub Insertmaster()
        ...
        SQLCommand("INSERT INTO Tknittcomxp(Comid,Knitcomdate,Knitcomno,Rcdate,Dlvno,
                    Dremark,WgtKgOrder,WgtKgStore,QtyrollOrder,QtyrollStore,Updusr,Uptype,Uptime)
                    VALUES('" & Gscomid & "','" & Formatshortdatesave(Dtpknitcomdate.Value) & "','" & Trim(Tbknitcomno.Text) & "','" & Formatshortdatesave(Dtprecdate.Value) & "','" & Trim(Tbdlvyarnno.Text) & "',
                    '" & Trim(Tbremark.Text) & "','" & WgtKgOrder.Text & "','" & WgtKgStore.Text & "','" & QtyrollOrder.Text & "','" & QtyrollStore.Text & "','" & Gsuserid & "','A','" & Formatdatesave(Now) & "')")
    End Sub
    Private Sub Editmaster()
        SQLCommand("UPDATE Tknittcomxp SET Knitcomdate = '" & Formatshortdatesave(Dtpknitcomdate.Value) & "',Rcdate = '" & Formatshortdatesave(Dtprecdate.Value) & "',
                    Dlvno = '" & Trim(Tbdlvyarnno.Text) & "',Dremark = '" & Trim(Tbremark.Text) & "',WgtKgOrder = '" & WgtKgOrder.Text & "',WgtKgStore = '" & WgtKgStore.Text & "',QtyrollOrder = '" & QtyrollOrder.Text & "',QtyrollStore = '" & QtyrollStore.Text & "',Updusr = '" & Gsuserid & "',Uptype = 'E',
    ...
    '        'TbCalKG.Text = (Trim(Vdeliyarndet.Rows(0)("WgtKG")) - Tbwgtkg.Text)
    ...
    End Sub
    'Test 30/09/2018
    Private Sub ShowStore()
        Tbwgtkg.Text = WgtKgOrder.Text
        'WgtKgStore.Text = Math.Round((WgtKgStore.Text - Tbwgtkg.Text))
        'QtyrollsOrder.Text = Tbqtyroll.Text
        'QtyrollStore.Text = Math.Round((Tbwgtkg.Text / 20) - Tbqtyroll.Text)
    End Sub
